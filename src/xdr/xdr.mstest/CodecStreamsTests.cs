...
public class CodecStreamsTests
{
    ...
    public static ILogger<CodecStreamsTests>? Logger { get; } = LoggerProvider.CreateLogger<CodecStreamsTests>();
    ...
    public void A01LoggerTraceListenerShouldHaveMessages()
    {
        ...
        Assert.IsTrue( this._traceListener?.Any( TraceEventType.Information ), $"{nameof( this._traceListener )} should have {TraceEventType.Information} messages" );
